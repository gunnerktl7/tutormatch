...
<?php
session_start();
if(!isset($_SESSION['tuteelogin']) || !isset($_SESSION['tuteeid'])) {
  ?>
  <form action="tuteeregister.php" method="POST">
  <center><h2>Registration for tutee</h2></center>
  ...
  <form action="tuteelogin.php" method="POST">
    <table align="center">
      <tr align="center">
...
if(isset($_SESSION['tuteelogin']) && isset($_SESSION['tuteeid']))
{
    ...
    include("bd.php");
    $user=$_SESSION['tuteelogin'];
    $res=mysql_query("SELECT * FROM `tutee` WHERE `tuteelogin`='$user'");
    if($res == FALSE) {
    ...
    echo "<center>";
    echo "Go to <a href='mypagetutee.php'>My page</a>";
    echo "</center>";
}
?>
</div>
