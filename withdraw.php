...
$regid = $_GET['id'];
$query="UPDATE `registration` SET `status`='withdrawed' WHERE `registrationid`='$regid'";
$result=mysql_query($query);
if($result==true) {
    echo "You withdrawed this class<b><br>";
    echo "Please, go to <a href='myclasses.php'>My offers</a>";
    }
    else {
